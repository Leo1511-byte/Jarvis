...
calendar/email/GitHub (intentionally deferred — see `SECURITY.md`), System/Settings' real
content and the device-connection panel from `PROJECT_OBJECTIVE.md` (M36-37, not started — the
`System` nav item exists and honestly shows "not built yet").
